...
document.querySelectorAll('.project-card, .research-card, .student-card, .course-card, .service-category').forEach(el => {
    el.style.opacity = '0';
...
// Prevent external links from being treated as internal
